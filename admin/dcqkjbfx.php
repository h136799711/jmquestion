...
?>
	...
	<div id="dcqkjbfx">
		...
		<div id="dcqkjbfx_search" style="">
				　调查对象：
				<select name="object" onchange="location.href='?object='+this.value">
					<?php
				...
				<select name="bid" onchange="location.href='?object=<?php echo $object;?>&bid='+this.value">
					<?php
						$query = "select * from basicinfo where Basic_Object = '$object' and Basic_Major = '{$_SESSION['major']}'";
						$result = mysql_query($query);
				...
				<br/><br/>
				<?php
					$query = "select * from student where Student_Object = '$object'";
					$sum = mysql_num_rows(mysql_query($query));
					$query = "select * from submit where Student_Object = '$object'";
				...
				<?php
					$query = "select * from basicinfo where Basic_Object = '$object' and Basic_ID = $bid and Basic_Major = '{$_SESSION['major']}'";
					$result = mysql_query($query);
