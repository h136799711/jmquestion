...
<script type="text/javascript">
	...
	function select3(value){
		...
		send_request("select3.php?object2="+object2+"&object1="+object1+"&object3="+value+"&major="+document.getElementById('majors').value);
	}
...
?>
	...
	<div id="dcqkjbfx">
		...
		<div id="dcqkjbfx_search" style="">
			　请选择专业：
				<select name="major" id="majors" onchange="javascript:location.href='?major='+this.value">
					<?php
						if(isset($_GET['major'])){
